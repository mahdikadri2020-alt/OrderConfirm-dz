      ...
      <div className="flex items-center justify-between px-4 sm:px-6 md:px-12 lg:px-20 py-3.5 sm:py-5 font-body max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-2.5 sm:gap-4">
          <button
            ...
            className="text-xs sm:text-base font-heading font-bold text-muted-foreground hover:text-foreground px-2 sm:px-4 py-2 transition-colors hidden sm:block"
          >
            Connexion
          </button>
          <button
            onClick={() => onGoToApp ? onGoToApp() : onOpenAuth('signup')}
            className="rounded-full px-4 py-2 sm:px-7 sm:py-3 text-xs sm:text-base font-heading font-extrabold bg-primary text-primary-foreground hover:bg-primary/90 transition-all shadow-md flex items-center gap-1.5 sm:gap-2 group shrink-0"
          >
